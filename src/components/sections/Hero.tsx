...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="flex flex-col gap-5 items-center bg-gradient-to-br from-[var(--color-primary-100)] to-white py-20 lg:py-32"
    >
      <div className="flex items-center gap-5">
        <span className="md:w-40 sm:w-25 w-12 h-[2px] bg-gradient-to-r from-white to-[var(--color-primary-600)]/70 rounded-full"></span>
        ...
        <span className="md:w-40 sm:w-25 w-12 h-[2px] bg-gradient-to-r from-[var(--color-primary-600)]/70 to-white rounded-full"></span>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <span className="text-[var(--color-primary-600)]">Smarter</span>,{" "}
              <span className="text-[var(--color-primary-600)]">Faster</span>,{" "}
