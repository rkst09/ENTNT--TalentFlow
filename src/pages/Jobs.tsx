    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <div className="flex sm:flex-row flex-col sm:gap-0 gap-2 justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-[var(--color-primary-800)] mb-2">Jobs</h1>
            <p className="text-[var(--color-primary-800)]/90">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="bg-[var(--color-primary)] text-white px-4 py-2 rounded-lg hover:bg-[var(--color-primary-700)] transition-colors duration-200 flex items-center space-x-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex sm:flex-row flex-col items-center space-x-2 sm:space-y-0 space-y-2 ml-4">
                      <button
                        ...
                        className="text-[var(--color-primary)] cursor-pointer hover:text-[var(--color-primary-700)] text-sm font-medium"
                      >
                        View
                      </button>
                      <button
