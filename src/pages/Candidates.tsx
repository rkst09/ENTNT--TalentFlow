...
const Candidates: React.FC = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl text-[var(--color-primary)] font-bold mb-2">
              Candidates
            </h1>
      ...
      <div className="mb-6">
            <div className="bg-white rounded-lg shadow-sm border border-[color:var(--color-primary-100)] p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {stages.map((stage) => {
          ...
          return (
            <div
              key={stage.id}
              className="bg-gray-50 border border-[color:var(--color-primary-100)] rounded-lg p-3 min-h-[600px] flex flex-col"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                      <button
                        ...
                        className="cursor-pointer border border-[var(--color-primary)] text-xs text-[var(--color-primary)] hover:text-[var(--color-primary-700)] font-medium px-2 py-1 rounded hover:bg-[var(--color-primary-100)]"
                      >
                        View
                      </button>
                      <div className="flex items-center space-x-2">
                        <button
                          ...
                          className="cursor-pointer text-xs text-[var(--color-primary)] hover:text-[var(--color-primary-700)] p-1 rounded hover:bg-gray-100"
                          title="Add Notes"
                        >
                          <svg
                            className="w-5 h-5"
  ...
  <div className="fixed inset-0 bg-[var(--color-primary-100)] bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white border border-[color:var(--color-primary-100)] rounded-lg p-6 w-full max-w-md mx-4">
