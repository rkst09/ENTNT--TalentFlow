    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <div className="flex gap-2 justify-between items-center">
          <div>
            <h1 className="md:text-3xl sm:text-2xl text-xl font-bold text-[var(--color-primary)] mb-2">
              Assessments
            </h1>
            <p className="text-[var(--color-primary)]/90 sm:text-sm text-xs">
          ...
          <div className="flex space-x-3">
            <button
              ...
              className="bg-[var(--color-primary)] cursor-pointer text-white px-4 py-2 rounded-lg hover:bg-[var(--color-primary-700)] transition-colors duration-200 flex items-center space-x-2"
            >
              <svg
                className="w-4 h-4"
                fill="none"
          ...
          {selectedJob && (
            <div className="mt-6 flex justify-end space-x-3">
              <button
                ...
                className="px-4 py-2 cursor-pointer bg-[var(--color-primary)] text-white rounded-lg hover:bg-[var(--color-primary-700)] transition-colors duration-200"
              >
                Create
              </button>
            </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <span className="px-2 py-1 text-xs font-medium rounded-full bg-[var(--color-primary-100)] text-[var(--color-primary-800)]">
                    ...
                    <div className="flex sm:flex-row flex-col items-center space-x-2 sm:space-y-0 space-y-2 ml-4">
                      <button
                        ...
                        className="text-red-600 cursor-pointer hover:text-[var(--color-primary-700)] text-sm font-medium"
                      >
                        Edit
                      </button>
                      <button
